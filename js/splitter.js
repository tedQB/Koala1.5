...
;(function($){
	...
	$.fn.splitter = function(args){
		...
		return this.each(function() {
			...
			v:{ // Vertical
			moving:"left",sizing: "width", eventPos: "pageX",splitbarClass:"splitter",buttonClass: "splitterBtn", cursor: "e-resize"
			},
			h: { // Horizontal 
...
var Bt=$('<a href="javascript:void(0)"></a>').css("cursor",'pointer');
C.append(Bt);
