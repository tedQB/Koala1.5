(function () {
    ...
    */
    ...
    var KClass = this.KClass = (function () {
    ...
    */
    ...
    (function () {
        ...
        */
        ...
        function lambda(fn) {
            return isstr(fn) ? new Function("a", "b", "c", "return " + fn) : fn;
        }
        Kextend(K.C, {
            _Type: _Type,
            isObj: isObj,
    ...
    K.C.Kextend(Function.prototype, (function () {
        ...
        function Kproxy(v1, v2) {
            ...
            return function () {
                ...
                return fun.apply(scope, args.concat(Function.prototype.map(arguments)));
            };
        }
      ...
      .replace(/\s+/g, '').split(',');
        ...
        function Kcurry() {
            ...
            return function () {
                var a = Function.prototype.Kmerge(args, arguments);
    ...
    */
    ...
    var Kwdom = K.fn.create({
        ...
        child: function (idx) {
            ...
            return K(getChild(this.node, Array.prototype.map_(arguments)));
        },
        //第一个节点
        first: function () {
            return this.child(0);
      ...
      'removeClassName' : 'addClassName'](className);
        ...
        */
        ...
        bind: function (etype, fun, scope) {
            ...
            var fun2 = function (e) { fun.call(scope, KEvent, fdom) };
        ...
        click: function (fun, scope) {
            return this.addEvent("click", fun, scope);
        },

        //鼠标停留和移出事件
        hover: function (over_callback, out_callback) {
            this.addEvent("mouseover", over_callback);
            this.addEvent("mouseout", out_callback);
            return this;
        }
