(function () {
    ...
    */
    ...
    var K = this.K = this._K = this.Koala = function (v) {
        ...
        if (node) {
            var ClassK = KClass.create(Kwdom, {
                init: function (node) {
    ...
    */
    ...
    var Kwdom = K.fn.create({
        ...
        empty: function (typeid) {
            return Koala.each(function (obj, i, typeid) {
                if (K.C.unset(typeid)) {
        ...
        */
        ...
        insert: function (insertions) {
            return Koala.each(function (obj, i, insertions) {
                element = obj.node;
            ...
            return Koala.each(function (obj) {
                switch (obj.tag) {
                    case "select":
                        ...
                        break;
                    case "table":
                        obj.getBytags("tbody").item(0).html(v);
                        break;
                    case "thead":
                    case "tfoot":
                    case "tbody":
    ...
    var Knative = this.Knative = KClass.create(Kwdom, {
        ...
        //明天着重解决级联each和暴露给外围each相互分离，以及append方法优化！
